...
lista_de_transacoes = carrega("openai\\curso_1_openai\\dados\\transacoes.csv")
...
for uma_transacao in transacoes_analisadas["transacoes"]:
    if uma_transacao["status"] == "Possível Fraude":
        ...
        salva(f"openai\\curso_1_openai\\dados\\transacao-{id_transacao}-{produto_transacao}-{status_transacao}.txt", recomendacao)